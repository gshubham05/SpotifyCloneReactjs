...
function Player() {
    const { seekBg, seekBar, playStatus, Play, Pause,track,time,previous,forward,seekSong } = useContext(PlayerContext)
    return (
        <>
            <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
                ...
                <div className="flex flex-col items-center ap-1 m-auto">
                    <div className="flex gap-4">
                        ...
                        <img onClick={forward} className='w-4 cursor-pointer' src={assets.next_icon} alt="" />
